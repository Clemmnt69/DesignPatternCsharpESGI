...
namespace _4_Bridge
{
     public class FormulaireData : DataObject
    {
		private string codeFormulaire;
		private string libelle;

        public FormulaireData(string nomFormulaire)
        {
			this.codeFormulaire = "Formulaire_" + nomFormulaire;
            this.libelle = nomFormulaire;
        }

		public override List<Zones> CreeZonesData(int nombreZones)
        {
		...
		public override List<Champs> CreeChampsData(List<Zones> listeZones)
        {
            List<Champs> listeChamps = new List<Champs>();

			//Pour chaques zones, l'utilisateur ajoute des champs 
			foreach (Zones zone in listeZones)
			{
		...
		public override string CreeHTMLData(Formulaire formulaire)
        {
        ...
        public override void AfficherData(Formulaire formulaire)
        {

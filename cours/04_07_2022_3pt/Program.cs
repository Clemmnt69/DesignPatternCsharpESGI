...
namespace _04_07_2022_3pt
{
    //Main abstract class Liasse 
    ...
    //Variante d'une liasse : HTML, hérite de Liasse
    ...
    //Variante d'une liasse : PDF, hérite de Liasse
    ...
    { 
        ...
        { 
            string document; 
            //Modification ajout des guillement pour l'inclure dans une chaine de caractère
    ...
    //Class ClientVehicule appeler au moment du chargement de l'application
